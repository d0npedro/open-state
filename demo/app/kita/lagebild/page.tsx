  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <section id="kita-lagebild-regionenvergleich" aria-labelledby="kita-lagebild-regionen-heading">
        <div style={{ marginBottom: '1rem' }}>
          ...
          <p style={{ margin: 0, fontSize: '0.875rem', color: 'var(--color-text-muted)', maxWidth: '48rem' }}>
            ...
            Blatt 7 (Stichtag-Paare) und Blatt 8 (12-Monats-Verlauf-Paare, 4 Kennzahlen) aller
            exportierten Planungsräume.
          </p>
        </div>
      ...
      >
        ...
        Stichtag/Verlauf an der Komponente; Steuerungs-CSV Blatt 7 Stichtag-Paare und Blatt 8
        12-Monats-Verlauf-Paare (4 Kennzahlen: Warteliste, Auslastung, freie Plätze, Personal)
        aller exportierten Räume (i &lt; j, Meldebasis Session-sensitiv nur im Stichprobenmonat,
        optional Meldelücke-Filter); im Ausdruck Auswahl A/B und Kennzahl-Chips no-print,
        ...
        Handlungsfelder, Maßnahmen, Meldebasis-Stichprobe, Zeitreihe, Regionenvergleich Stichtag
        und Verlauf; Semikolon, UTF-8 BOM). Keine Interpolation, keine Trendbewertung. Keine
      ...
      <div className="no-print" style={{ fontSize: '0.85rem', color: 'var(--color-text-muted)' }}>
        ...
        Stichtag-Paare, Blatt 8 Verlauf-Paare 12 Monate). Druck und CSV: Status/Meldebasis und
        optionaler Meldelücke-Filter im Export.
