...
Zuletzt aktualisiert: nach Q-441 UG BG-Happy-Path E2E
...
| Letzte bekannte Prüfung | lint 2026-08-03; E2E chromium **335** Tests in **13** Specs (+ UG BG-Happy-Path Q-441) |
| E2E-Skripte | `test:e2e:ci` (chromium, workers=1); Domains: `test:e2e:av` · `test:e2e:ug` (inkl. BG-Happy-Path Q-441) · `test:e2e:kita`; zusätzlich `stories-zur-demo.spec.ts` in Gesamt-Suite |
...
| `docs/NEXT_STEPS_QUEUE.md` | Aktive Arbeitsliste | ✓ Q-442 OFFEN; Q-441 DONE |
