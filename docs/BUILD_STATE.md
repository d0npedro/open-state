...
|-------|--------|-----------|--------|
| `/` | Landing Page | – | ✓ |
| `/fall` | Fallübersicht, Status, Fairness-Summary inkl. BESCHEID-CTAs Zum Bescheid/Verlauf + Widerspruch-Countdown-Chip, Fristen-Countdown offener Unterlagen, Widerspruchsfrist-Kurzblock + Bescheid-Kachel Countdown, Upload-/Termin-/RQ-Quittungen mit Verlauf-Tiefenlinks, Fairness-UNTERLAGE-CTA live nächste Unterlage nach Teil-Upload, Termin-Kachel Status live | US-AV-001–007 | ✓ |
...
| AV Hinweise UNTERLAGE CTA live nächste Unterlage | `/fall/hinweise` UNTERLAGE-CTA | ✓ Nach Teil-Upload Tiefenlink `#dok-DOK-004` + Hint mit Bezeichnung (Q-222, US-AV-003/008) |
| AV Übersicht Fairness UNTERLAGE CTA live nächste Unterlage | `/fall` Fairness UNTERLAGE | ✓ Nach Teil-Upload Tiefenlink `#dok-DOK-004` + Hint + `data-next-dok-id` (Q-223, US-AV-003/007/008, Parität Q-222) |
