...
Zuletzt aktualisiert: nach Q-472 UG Skip-Link Übersicht/Hinweise
...
| Letzte bekannte Prüfung | lint 2026-08-03; E2E chromium **346** Tests (+ UG Skip-Link Q-472) |
| E2E-Skripte | `test:e2e:ci` (chromium, workers=1); Domains: `test:e2e:av` · `test:e2e:ug` · `test:e2e:kita`; Skip-Link UG Q-472, Kita Q-471, Fall Q-451, stories/feedback Q-461; Session-Reset RQ Q-462/Q-470; `stories-zur-demo.spec.ts` |
...
| `docs/NEXT_STEPS_QUEUE.md` | Aktive Arbeitsliste | ✓ Q-462 OFFEN; Q-461 DONE |
