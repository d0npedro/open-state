...
Zuletzt aktualisiert: nach Q-541 Skip-Link Kita Einrichtung/Tagesstand
...
| Letzte bekannte Prüfung | lint 2026-08-03; E2E chromium **377** Tests (+ Skip-Link Kita Einrichtung/Tagesstand Q-541) |
| E2E-Skripte | `test:e2e:ci` (chromium, workers=1); Domains: `test:e2e:av` · `test:e2e:ug` · `test:e2e:kita`; ThemeSwitcher Q-492/Q-501; BuildInfo Q-510; Footer/Feedback Q-520; Skip-Link Q-521/Q-532/Q-531/Q-540/Q-541; Stories Domain-Landmarks Q-530; Session-Reset Q-500; `stories-zur-demo.spec.ts` |
