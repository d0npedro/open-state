...
Zuletzt aktualisiert: nach Q-520 Footer/Feedback externe Links a11y
...
| Letzte bekannte Prüfung | lint 2026-08-03; E2E chromium **369** Tests (+ Footer/Feedback externe Links Q-520) |
| E2E-Skripte | `test:e2e:ci` (chromium, workers=1); Domains: `test:e2e:av` · `test:e2e:ug` · `test:e2e:kita` (inkl. Export-a11y Q-502/Q-511/Q-512); ThemeSwitcher Q-492/Q-501; BuildInfo Q-510; Footer/Feedback extern Q-520; Skip-Link; Session-Reset Q-500; `stories-zur-demo.spec.ts` |
...
| `docs/NEXT_STEPS_QUEUE.md` | Aktive Arbeitsliste | ✓ Q-521/Q-522 OFFEN; Q-520 DONE |
